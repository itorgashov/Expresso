...
-- Seed: seed.sql in this folder (from samples/database/seed.json).
...
(
    ...
    opens_at  TIME(0)          NOT NULL
        CONSTRAINT DF_publisher_opens_at DEFAULT ('09:00:00'),
    closes_at TIME(0)          NOT NULL
        CONSTRAINT DF_publisher_closes_at DEFAULT ('17:00:00'),
...
(
    ...
    external_id       UNIQUEIDENTIFIER NOT NULL
        CONSTRAINT DF_book_external_id DEFAULT (NEWID()),
