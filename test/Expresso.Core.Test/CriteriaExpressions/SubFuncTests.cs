...
namespace Expresso.Tests.Core.CriteriaExpressions
{
    public class SubFuncTests
    {
        ...
        public void Constructor_ValidArguments_SetsReturnType(Type validType)
        {
            ...
            var subFunc = new SubFunc(argument1, argument2);

            Assert.Equal(subFunc.Arguments?.Count, 2);
            Assert.Equal(argument1, subFunc.Arguments?[0]);
            Assert.Equal(argument2, subFunc.Arguments?[1]);
            Assert.Equal(validType, subFunc.ReturnType);
        }
        ...
        public void Constructor_SetsReturnTypeAsFirstArgType()
        {
            ...
            Assert.Equal(argument1, subFunc.Arguments?[0]);
            Assert.Equal(argument2, subFunc.Arguments?[1]);
            Assert.Equal(argument1.ReturnType, subFunc.ReturnType);
        }
        ...
        public void Constructor_1stNullArgument_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new SubFunc(null!, argument2));
        }
        ...
        public void Constructor_2ndNullArgument_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new SubFunc(argument1, null!));
        }
        ...
        public void Constructor_Invalid1stArgumentType_ThrowsArgumentException(Type invalidType)
        {
            ...
            Assert.Throws<ArgumentException>(() => new SubFunc(argument1, argument2));
        }
