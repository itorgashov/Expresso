...
namespace Expresso.Tests.Core.CriteriaExpressions
{
    public class AddFuncTests
    {
        ...
        public void Constructor_ValidArguments_SetsReturnType(Type validType)
        {
            ...
            var addFunc = new AddFunc(argument1, argument2);

            Assert.Equal(addFunc.Arguments?.Count, 2);
            Assert.Equal(argument1, addFunc.Arguments?[0]);
            Assert.Equal(argument2, addFunc.Arguments?[1]);
            Assert.Equal(validType, addFunc.ReturnType);
        }
        ...
        public void Constructor_SetsReturnTypeAsFirstArgType()
        {
            ...
            Assert.Equal(argument1, addFunc.Arguments?[0]);
            Assert.Equal(argument2, addFunc.Arguments?[1]);
            Assert.Equal(argument1.ReturnType, addFunc.ReturnType);
        }
        ...
        public void Constructor_1stNullArgument_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new AddFunc(null!, argument2));
        }
        ...
        public void Constructor_2ndNullArgument_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new AddFunc(argument1, null!));
        }
        ...
        public void Constructor_Invalid1stArgumentType_ThrowsArgumentException(Type invalidType)
        {
            ...
            Assert.Throws<ArgumentException>(() => new AddFunc(argument1, argument2));
        }
