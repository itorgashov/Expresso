...
namespace Expresso.Parsing
{
    ...
    {
        private static bool TryCreateNumericFunction(string functionName, List<AbstractExpression> arguments, out AbstractExpression result)
        {
        ...
        private static AbstractExpression CreateMod(List<AbstractExpression> arguments)
        {
            RequireCount(arguments, 2, "Mod() function should have 2 arguments.");
            return CreateNumericArithFunction<ModFunc>(arguments);
        }

        private static AbstractExpression CreateFloor(List<AbstractExpression> arguments)
        {
            RequireCount(arguments, 1, "Floor() function should have 1 argument.");
            return CreateNumericSingleArgFunction<FloorFunc>(arguments);
        }

        private static AbstractExpression CreateCeiling(List<AbstractExpression> arguments)
        {
        ...
        private static AbstractExpression CoerceToNumeric(AbstractExpression expression)
        {
